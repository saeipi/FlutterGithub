class ASXRepo {
  ...
  ASXRepo.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    ...
    license =
    json['license'] != null ? new ASXLicense.fromJson(json['license']) : null;
  }
...
class ASXLicense {
  ...
  ASXLicense({this.key, this.name, this.spdxId, this.url, this.nodeId});

  ASXLicense.fromJson(Map<String, dynamic> json) {
    key = json['key'];
    name = json['name'];
    spdxId = json['spdx_id'];
    url = json['url'];
